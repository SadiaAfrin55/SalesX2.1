...
class FoeMarkDayoffAttendance extends StatefulWidget {
  const FoeMarkDayoffAttendance({Key? key}) : super(key: key);

  @override
  _FoeMarkDayoffAttendanceState createState() => _FoeMarkDayoffAttendanceState();
}

class _FoeMarkDayoffAttendanceState extends State<FoeMarkDayoffAttendance> {
                      ...
                      addrerss == null ? Container() : _image == null ? Container(child: Center(child: Text(''),),)
                          ...
                          onTap: () {
                            if (_globalkey.currentState!.validate()) {
                              ...
                              //BlocProvider.of<FoeAttendenceCubit>(context).giveSignOffAttendance(_image!,useId!,note.text==""?"N/A":note.text);
