...
class OMHomePage extends StatefulWidget {
  const OMHomePage({Key? key}) : super(key: key);

  @override
  _OMHomePageState createState() => _OMHomePageState();
}

class _OMHomePageState extends State<OMHomePage> {
                  ...
                  Padding(
                    ...
                    child: GridView(
                      ...
                      children: [
                        ...
                        BigButtonIcon(text: "FOM’s Activity",color: const Color(0xFFE0EDFF),image: "assets/icons/cardIcon/glass.svg",tap: (){
