...
class FoeTarget extends StatefulWidget {
  const FoeTarget({Key? key}) : super(key: key);

  @override
  _FoeTargetState createState() => _FoeTargetState();
}

class _FoeTargetState extends State<FoeTarget> {
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  //IconButton(onPressed: (){print("linemanagerid"+linemanagerid!);}, icon: Icon(Icons.add_location_rounded)),
