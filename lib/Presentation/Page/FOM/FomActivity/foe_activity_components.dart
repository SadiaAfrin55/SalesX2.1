...
class FoeActivityComponents extends StatefulWidget {
  const   FoeActivityComponents({Key? key}) : super(key: key);

  @override
  State<FoeActivityComponents> createState() => _FoeActivityComponentsState();
}

class _FoeActivityComponentsState extends State<FoeActivityComponents> {
