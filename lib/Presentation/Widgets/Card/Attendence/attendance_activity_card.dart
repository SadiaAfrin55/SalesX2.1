...
class AttendenceActivityCard extends StatefulWidget {
  final String? img;
  final String? checkIn;
  final String? checkOut;
  final String? attendenceDate;
  final String? status;
  const AttendenceActivityCard({
    //this.img,
    this.checkIn,
    this.checkOut,
    this.attendenceDate,
  ...
  @override
  State<AttendenceActivityCard> createState() => _AttendenceActivityCardState();
}

class _AttendenceActivityCardState extends State<AttendenceActivityCard> {
