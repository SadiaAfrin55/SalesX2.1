...
class TrainingActivityCard extends StatefulWidget {
  final String? img;
  final String? checkIn;
  final String? checkOut;
  final String? attendenceDate;
  final String? status;
  const TrainingActivityCard({
    //this.img,
    this.checkIn,
    this.checkOut,
    this.attendenceDate,
  ...
  @override
  State<TrainingActivityCard> createState() => _TrainingActivityCardState();
}

class _TrainingActivityCardState extends State<TrainingActivityCard> {
